...
<body class="main-page">
    ...
    ?>
        ...
        <hr width=14.9% color="black" style="margin-top:5px; margin-left:603px; position:absolute; z-index:1; height:0.2px">

        <p style="text-align:justify;margin-top:-6px;margin-left:613px; width:75%; position:absolute;z-index:5; font-size:10px"><b>NO</b>
            <hr width=14.9% color="black" style="margin-top:25px; margin-left:603px; position:absolute; z-index:1; height:0.2px">
    ...
    <!-- Tabel -->
    <!-- Garis baris 1 -->
    <hr style="margin-left:50px;margin-top:120px;position:absolute;z-index:0" width=84.5% color="black" height=1px>
    <!-- Garis baris 2 -->
    <hr style="margin-left:531.8px;margin-top:140px;position:absolute;z-index:0" width=23.8% color="black" height=1px>
    <!-- Garis baris 2 -->
    <hr style="margin-left:50px;margin-top:290px;position:absolute;z-index:0" width=84.5% color="black" height=1px>
    <hr style="margin-left:50px;margin-top:340px;position:absolute;z-index:0" width=84.5% color="black" height=1px>
    ...
    <p style="text-align:justify;margin-top:360px;margin-left:558px; width:75%; position:absolute;z-index:5; font-size:12px"><?php echo 'NIP. ' . $data2->nip_pj_kegiatan ?>
        ...
        <hr style="margin-left:50px;margin-top:520px;position:absolute;z-index:0" width=84.5% color="black" height=1px>
        <!-- Garis baris 2 -->
        <hr style="margin-left:50px;margin-top:540px;position:absolute;z-index:0" width=60.8% color="black" height=1px>
        <!-- Garis baris 2 -->
        <hr style="margin-left:50px;margin-top:600px;position:absolute;z-index:0" width=84.5% color="black" height=1px>
    ...
    <p style="text-align:justify;margin-top:417px;margin-left:250px; width:75%; position:absolute;z-index:5; font-size:12px">Catatan :
        ...
        <hr style="margin-left:50px;margin-top:640px;position:absolute;z-index:0" width=84.5% color="black" height=1px>
        <!-- Garis baris 2 -->
        ...
        <hr style="margin-left:50px;margin-top:860px;position:absolute;z-index:0" width=84.5% color="black" height=1px>
    <div style="border-left: 1px solid rgba(0, 0, 0, 0.1);
            height: 20.6px;
            position:absolute;
            left: 205px;
    ...
    <p style="text-align:justify;margin-top:737px;margin-left:540px; width:75%; position:absolute;z-index:5; font-size:11px"><b><?php echo $data2->nama_ppk ?></b>
        ...
        <hr style="margin-left:50px;margin-top:900px;position:absolute;z-index:0" width=84.5% color="black" height=1px>
        <!-- Garis baris 2 -->
        <hr style="margin-left:50px;margin-top:920px;position:absolute;z-index:0" width=19.6% color="black" height=1px>
        <!-- Garis baris 2 -->
        <hr style="margin-left:50px;margin-top:1029px;position:absolute;z-index:0" width=84.5% color="black" height=1px>
    <div style="border-left: 1px solid rgba(0, 0, 0, 0.1);
            height: 20.6px;
            position:absolute;
            left: 205px;
