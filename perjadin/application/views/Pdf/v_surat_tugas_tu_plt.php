...
<body class="main-page">
    ...
    <p style="margin-top:-20px; margin-left:489px;font-size:13px">Plh. Kepala Balai,</p><br><br><br>
    <p style="margin-top:-20px; margin-left:489px;font-size:13px"><?php echo $p1->nip_plt ?></p>
    <p style="margin-top:-20px; margin-left:489px;font-size:13px"><?php echo $p1->nama_plt ?></p>
