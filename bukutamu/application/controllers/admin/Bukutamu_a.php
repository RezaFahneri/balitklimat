...
class Bukutamu_a extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $getdetail = $this->Model_buku_tamu->join3('buku_tamu', 'data_pegawai', $ket1, 'data_divisi', $ket2, $where, 'Bertemu');
        $data['detail'] = $getdetail;
        $keterangan = ['jenis' => 'Tidak Bertemu'];
    ...
    {
        $data['title'] = 'Admin | Detail Tamu Bertamu';
        $data['sub'] = 'Detail Buku Tamu - Bertemu';
        $ket1 = 'data_pegawai.nip = buku_tamu.pegawai_nip';
        $ket2 = 'data_divisi.id_divisi = buku_tamu.id_divisi';
    ...
    public function export_excela()
    {
        ...
        $where = 'buku_tamu.jenis';
        $tamu = $this->Model_buku_tamu->ajoin3('buku_tamu', 'data_divisi', 'data_pegawai', $ketb, $keta, $where, 'Bertemu', 'left', 'left')->result();
        // var_dump($tamu);
