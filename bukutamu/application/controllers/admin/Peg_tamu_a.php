...
class Peg_tamu_a extends CI_Controller
{
    ...
    {
        $data['title'] = 'Admin-Peg | Tamu Bertemu';
        ...
        $this->load->view('admin/data_tamu/bukutamu', $data);
    ...
    public function detail($id_buku_tamu)
    {
        ...
        $this->load->view('templates/navbar', $data);
        $this->load->view('templates/sidebar_adm');
        $this->load->view('admin/data_tamu/v_detail', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function tambah($id_buku_tamu)
    {
        ...
        redirect('admin/peg_tamu_a/detail/' . $id_buku_tamu);
    }
