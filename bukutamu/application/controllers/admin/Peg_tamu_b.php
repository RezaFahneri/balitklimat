...
class Peg_tamu_b extends CI_Controller
{
    ...
    {
        $data['title'] = 'Admin-peg | Tamu Tidak Bertemu';
        ...
        $this->load->view('admin/data_tamu/bukutamu_b', $data);
        $this->load->view('templates/footer');
    }

    public function detail($id_buku_tamu)
    {
        $data['title'] = 'Admin-peg | Detail Penugasan';
        ...
        $this->load->view('templates/navbar', $data);
        $this->load->view('templates/sidebar_adm');
        $this->load->view('admin/data_tamu/v_detail_b', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function tambah($id_buku_tamu)
    {
        ...
        redirect('admin/peg_tamu_b/detail/' . $id_buku_tamu);
    }
