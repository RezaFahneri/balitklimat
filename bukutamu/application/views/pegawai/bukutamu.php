                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <div class="mt-3">
                                <div class="mt-3">
                                    <div class="table-responsive">
                                        <table class="table table-bordered tabel-hover" id="peg_bukutamu" cellspacing="0">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a onclick="return confirm('Apakah anda yakin menghapus data?')" class="btn btn-sm btn-danger" href="<?= base_url('pegawai/bukutamu_a/hapusall/' . $d->id_buku_tamu) ?>"><i class="ti ti-trash"></i></a>
