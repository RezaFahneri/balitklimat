<div class="main-panel">
    <div class="content-wrapper">
        <a href="<?= base_url(); ?>pegawai/bukutamu_b" class="btn btn-light mb-2"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="table-responsive">
                            <h3 class="font-weight-bold mb-10">Detail Buku Tamu - Tidak Bertemu</h3>
                            <?php
                            if ($detail->laporan) { ?>
                                <button class="btn btn-sm btn-info float-right mb-3 " data-toggle="modal" data-target="#editlap2"><i class="ti ti-pencil"></i> Laporan</button>

                            <?php } else { ?>
                                <button class="btn btn-sm btn-primary float-right mb-3 " data-toggle="modal" data-target="#addlap2"><i class="ti ti-plus"></i> Laporan</button>
                            <?php } ?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <?php
                                if ($detail->laporan) { ?>
                                    <a onclick="return confirm('Apakah anda yakin untuk menghapus laporan?')" href="<?= base_url('pegawai/bukutamu_b/hapus/' . $detail->id_buku_tamu) ?>" class="btn btn-sm btn-danger float-right"><i class="ti ti-trash"></i></a>
                                    <div class="com-text">
    ...
    <!-- Modal -->
    <div class="modal fade" id="addlap2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?= base_url('pegawai/bukutamu_b/tambah/' . $detail->id_buku_tamu) ?>">
    ...
    <!-- Modal -->
    <div class="modal fade" id="editlap2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
