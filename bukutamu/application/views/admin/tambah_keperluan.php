                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <h3 class="font-weight-bold mb-10">Tambah Keperluan</h3>
                        </div>
                        <?= $this->session->flashdata('message'); ?>
                        <?= form_open_multipart('admin/tambah_data/tambah_keperluan', 'class="mt-4"'); ?>
                        <div class="form-group">
                            <label for="namakep">Nama Keperluan<i style="color:red">*</i></label>
                            <input type="text" class="form-control form-control-user" id="namakep" name="namakep" value="<?= set_value('namakep'); ?>">
                            <?php echo form_error('namakep', '<small class="text-danger">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="ketkep">Keterangan<i style="color:red">*</i></label>
                            <textarea class="form-control" id="ketkep" name="ketkep" rows="13"><?= set_value('ketkep'); ?></textarea>
