                    ...
                    <div class="col-lg-5 mx-auto">
                        ...
                        <div class="auth-form-light py-5 px-4 px-sm-5">
                            <div class="text-center">
                                ...
                                <h5><b>Sistem Informasi Magang</b></h5>
                                <h5><b>Balai Penelitian Agroklimat dan Hidrologi</b></h5>
                                <h5><b>Ubah Sandi untuk Peserta</b></h5>
                                <!-- <h4><b>Lupa Kata Sandi</b></h4> -->
                            </div> <?= $this->session->flashdata('message'); ?>
                            <form class="pt-3" method="post" action="<?= base_url('masuk/ubah_sandi'); ?>">
                                <div class="form-group text-left">
                                    ...
                                    <?php echo form_error('ks1', '<small class="text-danger">', '</small>'); ?>
                                </div>
                                <div class="form-group text-left">
                                    <label class="form-label">
                                ...
                                <div class="mt-3">
                                    <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">Ubah</button>
                            </form>
                        </div>
                    </div>
                </div>
