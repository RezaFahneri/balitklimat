<div class="main-panel">
    <div class="content-wrapper">
        <a href="<?= base_url('pegawai/penugasan') ?>" class="btn btn-light mb-2"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
