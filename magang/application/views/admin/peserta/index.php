    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php
                if ($sub == 'Data Peserta Bimbingan') { ?>
                    <button title="Ekspor ke PDF" type="button" class="btn ml-2 btn-sm btn-danger float-right mb-2" data-toggle="modal" data-target="#exportpdf">
                    ...
                    <a title="Exspor ke Excel" class="btn btn-sm btn-primary float-right mb-2" href=" <?= base_url('admin/peserta/export_excel') ?>"> <i class=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-spreadsheet" viewBox="0 0 16 16">
                ...
                <?php } else { ?>
                    ...
                    <a title="Exspor ke Excel" class="btn btn-sm btn-primary float-right mb-2" href=" <?= base_url('admin/peserta/export_excel2') ?>"> <i class=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-spreadsheet" viewBox="0 0 16 16">
                                <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V9H3V2a1 1 0 0 1 1-1h5.5v2zM3 12v-2h2v2H3zm0 1h2v2H4a1 1 0 0 1-1-1v-1zm3 2v-2h3v2H6zm4 0v-2h3v1a1 1 0 0 1-1 1h-2zm3-3h-3v-2h3v2zm-7 0v-2h3v2H6z" />
                            </svg></i> Excel</a>
                <?php } ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <?php
                                                if ($pm->status_pm == 'none') { ?>
                                                    <a title="Hapus peserta" onclick="return confirm('Apakah anda yakin untuk menghapus peserta?')" class="btn btn-sm btn-danger" href="<?= base_url('admin/peserta/hapus2/' . $pm->id_pm) ?>"><i class="ti ti-trash"></i></a>
                                                <?php } ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><?php
                                                ...
                                                <?php } else { ?>
                                                    <a class="badge badge-warning">Blm Aktf</a>
                                                <?php } ?>
                                            </td>
                                            <td style="text-align: center;">
                                                <?php
                                                if ($pm->pembimbing_balai != $nip) { ?>
                                                    <a title="Lihat detail peserta" class="btn btn-sm btn-primary" href=" <?= base_url('admin/peserta/detail/' . $pm->id_pm) ?>"><i class="ti ti-eye"></i></a>
                                                <?php } else { ?>
                                                    <a title="Lihat detail peserta" class="btn btn-sm btn-info" href=" <?= base_url('admin/peserta/detail/' . $pm->id_pm) ?>"><i class="ti ti-eye"></i></a>
                                                <?php } ?>
                                                <?php
                                                if ($pm->status_pm == 'none') { ?>
                                                    <a title="Hapus peserta" onclick="return confirm('Apakah anda yakin untuk menghapus peserta?')" class="btn btn-sm btn-danger" href=" <?= base_url('admin/peserta/hapus/' . $pm->id_pm) ?>"><i class="ti ti-trash"></i></a>
                                                <?php } ?>
                                                <!-- <a class="btn btn-sm btn-success"><i class="ti ti-pencil"></i></a> -->
                                            </td>
                                        </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Filter Data PDF</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" action="<?= base_url('admin/peserta/export_pdf') ?>" target="_blank">
                    <label>
...
<div class="modal fade" id="exportpdf2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= base_url('admin/peserta/export_pdf2') ?>" target="_blank">
                    <!-- <?= form_open_multipart('admin/peserta/export_pdf2') ?> -->
                    <label>
                        <h6 class="font-weight-bold">Tanggal Mulai</h6>
                    </label>
