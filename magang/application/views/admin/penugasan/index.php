                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <div class="mt-3">
                                <?php
                                if ($peserta) { ?>
                                    <a title="Tambah penugasan" href="<?= base_url() ?>admin/penugasan/tambah" class="btn btn-primary btn-sm btn-icon-text mb-2">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a title="Lihat detail penugasan" class="btn btn-sm btn-info" href="<?= base_url('admin/penugasan/detail/' . $dt->id_tugas) ?>"><i class="ti ti-eye"></i></a>
                                                        <!-- <a class="btn btn-sm btn-success"><i class="ti ti-pencil"></i></a> -->
                                                        <a title="Hapus penugasan" onclick="return confirm('Apakah anda yakin untuk menghapus data?')" class="btn btn-sm btn-danger" href="<?= base_url('admin/penugasan/hapus/' . $dt->id_tugas) ?>"><i class="ti ti-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
