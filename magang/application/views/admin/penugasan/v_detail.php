<div class="main-panel">
    <div class="content-wrapper">
        <a href="<?php echo base_url(); ?>admin/penugasan" class="btn btn-light mb-2"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
            ...
            <div class="col-12 grid-margin">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <a title="Lihat detail hasil tugas" class="btn btn-sm btn-info" href=" <?= base_url('admin/penugasan/detail_peserta/' . $dt->id_det_tugas) ?>"><i class="ti ti-eye"></i></a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a title="Edit Penugasan" href="<?= base_url('admin/penugasan/edit/' . $detail->id_tugas) ?>" class="btn btn-sm btn-primary float-right mb-3"><i class="ti ti-pencil"></i>Edit</a>
                        <div class="px-3">
