                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center;">
                                                                <a title="Lihat detail laporan" class="btn btn-sm btn-info" href="<?= base_url('admin/laporan/detail/' . $d->id_lap_ming) ?>"><i class="ti ti-eye"></i></a>
                                                                <!-- <a class="btn btn-sm btn-success"><i class="ti ti-pencil"></i></a> -->
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center;"> <?php
                                                                    ...
                                                                    <a title="Lihat detail laporan" class="btn btn-sm btn-primary" href="<?= base_url('admin/laporan/det_lap/' . $d->id_lap_ming) ?>"><i class="ti ti-eye"></i></a>
                                                                    <!-- <a class="btn btn-sm btn-success"><i class="ti ti-pencil"></i></a> -->
                                                                <?php } else { ?>
                                                                    <a title="Lihat detail laporan" class="btn btn-sm btn-info" href="<?= base_url('admin/laporan/detail/' . $d->id_lap_ming) ?>"><i class="ti ti-eye"></i></a>
                                                                <?php } ?>
