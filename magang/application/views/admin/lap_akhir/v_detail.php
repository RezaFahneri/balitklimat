<div class="main-panel">
    <div class="content-wrapper">
        <?php
        if ($detail->nip == $nip) { ?>
            <a href="<?= base_url(); ?>admin/lap_akhir" class="btn btn-light mb-2"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z" />
                    </svg></i> Kembali ke <b>Laporan Akhir Peserta Bimbingan</b></a>
        <?php } else { ?>
            <a href="<?= base_url(); ?>admin/lap_akhir/lap_akhir_seluruh" class="btn btn-light mb-2"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z" />
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="px-3 mt-3">
                                    <table class="table col-lg table-sm table-borderless" style="width: 100%">
                                        ...
                                        <td><?= $detail->tgl_up_lapak ?></td>
                                            ...
                                            <tr>
                                                <th>Nama Peserta</th>
                                                <td><a class="text-primary" href=" <?= base_url('admin/peserta/detail/' . $detail->id_pm) ?>">
                        ...
                        <?php
                        if ($detail->nip == $nip) { ?>
                            <a href="<?= base_url(); ?>admin/lap_akhir" class="btn btn-light float-right">Kembali</a>
                        <?php } else { ?>
                            <a href="<?= base_url(); ?>admin/lap_akhir/lap_akhir_seluruh" class="btn btn-light float-right">Kembali</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
