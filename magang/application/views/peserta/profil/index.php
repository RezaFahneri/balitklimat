            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <div class="row">
                                <div class="col-md-12"> <a title="Edit profil" class="btn btn-sm btn-primary float-right" href="<?= base_url('peserta/profil/edit_profil/' . $user2['id_pm']) ?>"><i class="ti ti-pencil"></i>Edit</a></div>
                                <div class="col-md-12">
