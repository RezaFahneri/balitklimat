            ...
            <div class="col-md-12 grid-margin">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h3 class="m-0 font-weight-bold text-primary">Tambah Jadwal Kenaikan Gaji Berkala</h3><br>
                        <div class="col-md-12 grid-margin">
                            <div class="card-body">
                                <form method="POST" action="<?php echo base_url('jadwal_kgb/tambah_aksi') ?>">
                                    <div class="form-group">
                                        <!-- <label><b>Kode Kenaikan Pangkat</b></label> -->
                                        <input readonly type="hidden" name="kode_kgb" value="<?php echo $jadwal_kgb;?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" id="golongan" name="golongan" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="pangkat"><b>Pangkat </b></label>
                                        <input readonly type="text" id="pangkat" name="pangkat" class="form-control">
                                    </div>
                                    <div class="form-group">
