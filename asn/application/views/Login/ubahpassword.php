                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-5 mx-auto">
                        ...
                        <div class="wrapper auth-form-light text-center py-5 px-4 px-sm-5">
                            ...
                            <form class="pt-3 text-center" action="<?php echo base_url(); ?>login/ubahpassword"
                                method="post">
								<?= $this->session->flashdata('message') ?>
                                <div class="form-group">
                                    <input type="password" id='password1' class="form-control form-control" placeholder="Masukkan password baru"
                                        name='password1'>
										<?php echo form_error('password1','<small class="text-danger">','</small>'); ?>
                                </div>
								<div class="form-group">
                                    <input type="password" id='password2' class="form-control form-control" placeholder="Ulangi password baru"
                                        name='password2'>
                                ...
                                <div class="mt-3">
                                    <button type="submit"
                                        class="btn btn-block btn-success btn-md font-weight-medium auth-form-btn">Ubah Password</button>
                                </div></br>
