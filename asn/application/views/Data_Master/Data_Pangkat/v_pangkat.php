                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <div class="table-responsive">
                            <h3 class="m-0 font-weight-bold text-primary">Data Pangkat</h3><br>
                            ...
                            <div class="col-md-4 grid-margin">
                                <a href="<?php echo base_url() ?>pangkat/tambah" class="btn btn-success btn-md"><i
                                        class="ti ti-plus"></i>Tambah Pangkat</a>
                            </div>
                            <div class="col-md-12 grid-margin">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a style="font-size:30px" class="btn btn-sm btn-success"
                                                                    href="<?php echo base_url('/pangkat/edit/' . $p->id_pangkat) ?>"><i
                                                                        class="mdi mdi-lead-pencil"></i></a>
                                                                <a style="font-size:30px" id="hapus_pangkat"
                                                                    class="btn btn-sm btn-danger"
                                                                    href="<?php echo site_url('/pangkat/hapus/' . $p->id_pangkat) ?>"><i
