    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="card shadow mb-4">
                ...
                <h3 class="m-0 font-weight-bold text-primary">Edit Data Jabatan</h3><br>
                <div class="col-md-12 grid-margin">
                <div class="card-body">
                ...
                <div class="form-group">
                    <label>Jabatan </label>
                    <input type="text" name="jabatan" class="form-control" value="<?php echo $p->jabatan?>" name="jabatan" required>
                </div>
