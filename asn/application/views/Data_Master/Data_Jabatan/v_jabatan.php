            ...
            <div class="col-md-12 grid-margin">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h3 class="m-0 font-weight-bold text-primary">Data Jabatan</h3><br>
                        ...
                        <div class="col-md-4 grid-margin">
                            <a href="<?php echo base_url() ?>jabatan/tambah" class="btn btn-success btn-md"><i
                                    class="ti ti-plus"></i>Tambah Jabatan</a>
                        </div>
                        <div class="col-md-12 grid-margin">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a style="font-size:30px" class="btn btn-sm btn-success"
                                                                href="<?php echo base_url('/jabatan/edit/' . $j->id_jabatan) ?>"><i
                                                                    class="mdi mdi-pencil"></i></a>

                                                            <a style="font-size:30px" id="hapus_jabatan"
                                                                class="btn btn-sm btn-danger"
                                                                href="<?php echo site_url('/jabatan/hapus/' . $j->id_jabatan) ?>"><i
