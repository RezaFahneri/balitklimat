                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h3 class="m-0 font-weight-bold text-primary">
                            <h3 class="m-0 font-weight-bold text-primary"><a title="Kembali" class="btn btn-sm btn-secondary" style="border-radius:90px; color:white" href="<?php echo site_url('data_pegawai') ?>"><i class="ti ti-arrow-left" style="border-radius:8px"></i></a>&nbsp Detail Pegawai</h3><br>
                            <div class="col-md-12 grid-margin">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-9">
                                                <table class="table table-no-bordered">
                                                    ...
                                                    <!-- <tr>
                                                        <th>Role</th>
                                                        <td><? //php echo $detail->role
                                                            ?></td>
                                                    </tr> -->
                                                    <!-- <tr>
                                                    <th>Tugas Tambahan</th>
                                                    <td>
                                                    <td><?php //echo $detail->id_tugas
                                                        ?><?php //echo $detail->penugasan;
                                                                                        ?>
                                                    </td>
                                                    </td>
                                                </tr> -->
