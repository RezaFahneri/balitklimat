                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                                ...
                                <form method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input style="color:dimgray" type="text" name="nama_pegawai"
                                            placeholder="Nama Pegawai" autocomplete="off" class="form-control" required>
                        ...
                        <?php// echo form_error('foto', '<div class="text-small text-danger"></div>') ?>
                                    ...
                                    <div class="form-group">
                                        <label for="id_golongan"><b>Golongan<a style="color:red"> *</a></b></label></br>
                                    ...
                                    <div class="form-group">
                                        <label><b>Pangkat<a style="color:red"> *</a></b></label></br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select style="color:dimgray" name="id_jabatan" id="id_jabatan"
                                            ...
                                            <option value="<?php echo $row->id_jabatan;?>"><?php echo $row->jabatan;?>
                                            </option>';
                                            }
                                            <?php }?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select style="color:dimgray" class="form-control" name="role" required>
                                                ...
                                                <!-- <option value="admin_asn">Admin ASN</option>
                                                <option value="admin_perjadin">Admin Perjalanan Dinas</option>
                                                <option value="admini_nventaris">Admin Inventaris</option>
                                                <option value="admin_disposisi">Admin Disposisi</option>
                                                <option value="admin_bukutamu">Admin Buku Tamu</option>
                                                <option value="admin_diseminasi">Admin Bahan Diseminasi</option>
                                                <option value="admin_magang">Admin Laporan Magang</option>
