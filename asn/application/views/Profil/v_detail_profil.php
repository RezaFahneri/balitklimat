                                ...
                                <div class="col-lg-12 grid-margin stretch-card">
                                    <div class="card">
                                        <form enctype="multipart/form-data" method="POST"
                                            action="<?php echo base_url() ?>profil/update_foto">
                                            <div class="image-upload text-center">
                                                <label for="file-input">
                                                    ...
                                                    <img class="img-thumbnail" id="kamera"
                                                        ...
                                                        src="<?php echo base_url() ?>assets/images/kamera.png">
                                                    <button class="text-center" title="Simpan perubahan edit profile"
                                                        style="position:absolute;z-index:3;margin-left:140px;margin-top:155px"
                                                        type="submit" id="but"><img class="text-center"
                                                            style="width:35px;height:42px"
                                                            src="<?php echo base_url() ?>assets/images/ceklis.png"></button>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-xs-9">
                                            ...
                                            <div class="col-md-9 grid-margin">
                                                <a href="<?php echo base_url() ?>profil/edit?nip=<?php echo $data_pegawai['nip'] ?>"
                                                    class="btn btn-success btn-md"><i class="ti ti-pencil"></i>Ubah
                                                    Password</a>
                                            </div>
                                        </div>
                                    </div>
