...
class Role_Penugasan extends CI_Controller
{
    ...
    function hapus_tim_role($id_detail_role)
    {
        ...
        $this->session->set_flashdata(
            'sukses',
            'Data tim role berhasil dihapus'
        );
        redirect('role_penugasan');
    }
    function penugasan()
    ...
    function tambah_penugasan()
    {
        ...
        $this->load->view('templates/v_template', $data);
        $this->load->view(
            'Data_Master/Data_Tugas_Role/v_tambah_penugasan',
            $data
        );
        $this->load->view('templates/footer', $data);
    }
    ...
    function edit_penugasan($id_tugas)
    {
        ...
        $data['data_tugas'] = $this->db
            ->query("SELECT * FROM data_tugas WHERE id_tugas='$id_tugas'")
            ->result();
        $data['title'] = ' ASN Balitklimat | Edit Data Penugasan';
        $this->load->view('templates/v_template', $data);
        $this->load->view(
            'Data_Master/Data_Tugas_Role/update_penugasan',
            $data
        );
        $this->load->view('templates/footer', $data);
    }
    ...
    function hapus_tim_penugasan($id_detail_tugas)
    {
        ...
        $this->session->set_flashdata(
            'sukses',
            'Data tim penugasan berhasil dihapus'
        );
        redirect('role_penugasan/penugasan');
    }
    ...
    function tambah_tim_penugasan($id_tugas)
    {
        ...
        $this->load->view('templates/v_template', $data);
        $this->load->view(
            'Data_Master/Data_Tugas_Role/tambah_tim_penugasan',
            $data
        );
        $this->load->view('templates/footer', $data);
    }
