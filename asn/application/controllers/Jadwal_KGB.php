...
class Jadwal_KGB extends CI_Controller {
    ...
    function edit()
    {
        ...
        $data['update_jadwalkgb'] = $this->Model_kenaikan_gaji->getList2($kode_kgb);
    ...
    function update()
    {
        ...
        $this->session->set_flashdata('sukses','Jadwal kenaikan gaji berkala berhasil diperbarui');
        redirect('jadwal_kgb');
    }
