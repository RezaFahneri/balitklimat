...
class Model_kenaikan_pangkat extends CI_model
{
    ...
    function getList()
	{
        $this->db->select('data_jadwal_naik_pangkat.*,data_pegawai.*,data_golongan.*,data_pangkat.*,gol.golongan as nama_golongan,pag.pangkat as nama_pangkat');
    ...
    function getList2($kode_kp)
	{
        ...
        $this->db->join('data_golongan as gol', 'data_jadwal_naik_pangkat.id_golongan_berikutnya= gol.id_golongan');
        $this->db->join('data_pangkat as pag', 'data_jadwal_naik_pangkat.id_pangkat_berikutnya= pag.id_pangkat');
		return $this->db->where('kode_kp',$kode_kp)->get()->result();
	}
    ...
    function detail_jadwalkp($kode_kp){
        ...
        $this->db->join('data_golongan as gol', 'data_jadwal_naik_pangkat.id_golongan_berikutnya= gol.id_golongan');
        $this->db->join('data_pangkat as pag', 'data_jadwal_naik_pangkat.id_pangkat_berikutnya= pag.id_pangkat');
		return $this->db->where('kode_kp',$kode_kp)->get()->row();
	}
