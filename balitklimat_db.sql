...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Mar 2022 pada 17.29
...
('195805161993032002', 'Dr. Nani Heryani', 'WhatsApp_Image_2022-01-14_at_14_30_571.jpeg', 17, 1, 2, 2, 2, '3271055605580006', 'lugasmunayasika@gmail.com', '123', '6281235062988  ', 'User'),
...
('HNR1232211222', 'Ujang Suseno', 'default.png', 1, 7, 1, 5, 1, '12131231', 'ujang@gmail.com', '123', '62888488', 'User'),
('HNR932727', 'Asep Pisan', 'default.png', 1, 7, 1, 5, 1, '121371237', 'asep@gmail.com', '123', '62822221', 'User');
...
(5, 2, 'reza', '2022-03-11', '2022-03-16', 1, 'PKL', 'Bogor', 'Pembayaran sebesar 10000 telah diterima', 2);
...
(10, 'HNR1232211222', 'Ujang Suseno', 5, 1),
(11, 'HNR932727', 'Asep Pisan', 5, 1);
...
(2, 'GPS RTK', '2 Set Box + 2 Tripod', 0, 'b60fd606f3ba348e20cb746c00006dd2.png', 'Baik'),
...
('5', 1, 'HM.141', 4, '2022-03-04', 'Balai', 'Undangan', '', '2022-03-05', 4, ''),
...
('SM220306', 3, 'HM.141', 9, '2022-03-13', 'Balitklimat', 'baik', '', '2022-03-13', 9, 'Belum Disposisi'),
('SM220307', 3, 'HM.141', 10, '2022-04-04', 'Kementan', '-', '', '2022-04-04', 10, '195805161993032002'),
('SM220308', 3, 'HM.144', 11, '2022-03-07', 'Balitklimat', '-', '', '2022-03-07', 11, 'Belum Disposisi'),
('SM220309', 1, 'HM.142', 12, '2022-03-08', 'Kementan', '-', '', '2022-03-08', 12, '195805161993032002'),
('SM220310', 3, 'HM.142', 13, '2022-03-09', 'Kementan', '-', 'disposisi_surat_74.pdf', '2022-03-09', 13, '196401211990031002'),
('SM220311', 1, 'jhjk', 78779, '2022-03-06', 'hjhkjhkjhjkhjkh', 'cgfcfgdfgdgfdgf', '', '2022-03-14', 55, 'Belum Disposisi');
...
--
ALTER TABLE `status_kepegawaian`
  MODIFY `id_status_peg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `status_perjalanan`
--
ALTER TABLE `status_perjalanan`
  MODIFY `id_status_perjalanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
